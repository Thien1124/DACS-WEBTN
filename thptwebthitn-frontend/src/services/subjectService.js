...
export const getAllSubjects = async (filters = {}) => {
  ...
  try {
    ...
    console.warn(
      `[${currentTime}] Unexpected API response format, returning empty array`
    );
    return [];
  } catch (error) {
...
export const getSubjectById = async (id) => {
  try {
    console.log(
      `[${currentTime}] ${currentUser} is fetching subject with ID: ${id}`
    );
...
export const createSubject = async (subjectData) => {
  try {
    ...
    console.log(
      `[${currentTime}] Subject created successfully:`,
      response.data
    );
    return response.data;
  } catch (error) {
...
export const updateSubject = async (id, subjectData) => {
  try {
    console.log(
      `[${currentTime}] Updating subject with ID ${id}:`,
      subjectData
    );
    const response = await apiClient.put(`/api/Subject/${id}`, subjectData);
    console.log(
      `[${currentTime}] Subject updated successfully:`,
      response.data
    );
    return response.data;
  } catch (error) {
