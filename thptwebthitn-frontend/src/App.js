...
import OfficialExamCreate from "./components/admin/OfficialExamCreate";
import AssignStudentsToExam from "./components/admin/AssignStudentsToExam";
import ImportQuestionsFromExcel from "./components/admin/ImportQuestionsFromExcel";
import StudentResultsExport from "./components/admin/StudentResultsExport";
...
const AppContainer = styled.div`
  ...
  background-color: ${(props) =>
    props.theme === "dark" ? "#121212" : "#f7f7f7"};
...
function App() {
  ...
  useEffect(() => {
    ...
    if ((token && !userData) || (!token && userData)) {
      console.log(
        "Phát hiện trạng thái không nhất quán, xóa dữ liệu đăng nhập"
      );
      localStorage.removeItem("auth_token");
      localStorage.removeItem("refresh_token");
      localStorage.removeItem("user_data");
  ...
  const examReminders = useExamReminders(7);
  const { upcomingExams, dismissExam } = examReminders || {
    upcomingExams: [],
    dismissExam: () => {},
  };
        ...
        <AppContainer theme={theme}>
          ...
          <Routes>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/subjects/:id/exams" element={<ExamList />} />
              <Route
                path="/subject/create"
                element={
              ...
              />
              <Route
                path="/exams/by-subject/:subjectId"
                element={<ExamsBySubject />}
              />
              ...
              />
              <Route
                path="/subjects/:subjectId/top-students"
                element={<SubjectTopStudentsPage />}
              />
              <Route
                path="/admin/exams/:examId/details"
                element={
              ...
              />
              <Route
                path="/admin/exams/:examId/questions/:questionId/edit"
                element={<EditQuestion />}
              />
              <Route
                path="/admin/exams/official/create"
                element={
                  <AdminRoute>
                    <OfficialExamCreate />
                  </AdminRoute>
              ...
              <Route
                path="/admin/exams/:examId/assign-students"
                element={
                  <AdminRoute>
