...
namespace webthitn_backend.Controllers
{
    ...
    public class QuestionController : ControllerBase
    {
        ...
        [SwaggerOperation(
            Summary = "Nhập câu hỏi từ file Excel",
            Description = "API này cho phép nhập dữ liệu câu hỏi từ file Excel"
        )]
            ...
            [FromForm] int batchSize = 50)
        {
            try
            {
                ...
                {
                    selectedChapter = await _context.Chapters.FindAsync(categoryId.Value);
                ...
                try
                {
                    ...
                    for (int row = 2; row <= rowCount; row++)
                    {
                        ...
                        try
                        {
                            ...
                            int chapterId = selectedChapter?.Id ?? categoryId ?? 0;
                            if (chapterId == 0 && defaultChapter != null)
                            {
