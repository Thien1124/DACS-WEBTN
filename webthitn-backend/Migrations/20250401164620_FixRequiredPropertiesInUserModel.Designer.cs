...
namespace webthitn_backend.Migrations
{
    ...
    [Migration("20250401164620_FixRequiredPropertiesInUserModel")]
    partial class FixRequiredPropertiesInUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webthitn_backend.Models.Question", b =>
                {
                    ...
                    b.Property<float>("DefaultPoints")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("webthitn_backend.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Grade = "N/A",
                            IsActive = true,
                            Password = "$2a$11$WG9TQoX4JfzF5v70GE1/uO2sP.Ehi.oeeG8Vsaf.UIU2jCEifVDV2",
                            PhoneNumber = "N/A",
                            ResetPasswordCode = "",
                            Role = "Admin",
                            School = "N/A",
                        ...
                        new
                        {
                            ...
                            Password = "$2a$11$NSNk2UrxTxIxmSkZjddG0ORZjojm4Ofjz2D/2JIhBDW7zzvXhP4Si",
                        ...
                        new
                        {
                            ...
                            Grade = "12",
                            IsActive = true,
                            Password = "$2a$11$RJSEljqNcAuAvTGnK84rW.4JsctcnE7EJ4lP5w2nyLi.Y.IW8TrnO",
            ...
            modelBuilder.Entity("webthitn_backend.Models.Question", b =>
                {
                    b.HasOne("webthitn_backend.Models.Lesson", "Lesson")
                        .WithMany("Questions")
