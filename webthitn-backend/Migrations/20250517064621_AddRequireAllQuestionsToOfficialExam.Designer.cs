...
namespace webthitn_backend.Migrations
{
    ...
    [Migration("20250517064621_AddRequireAllQuestionsToOfficialExam")]
    partial class AddRequireAllQuestionsToOfficialExam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webthitn_backend.Models.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webthitn_backend.Models.PracticeResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webthitn_backend.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Grade = "N/A",
                            IsActive = true,
                            Password = "$2a$11$Bj.q1NWECsVoBSnUcMrwFuGSuI.XD2Fqf10T5dQpZrsU6VAw4lMdW",
                            PhoneNumber = "N/A",
                            Role = "Admin",
                            School = "N/A",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            Password = "$2a$11$BHpL6WTyGwMVU2ui5HjCZ.C86/i14gvXYkT0LiDdUiiIKhUyFw98W",
                        ...
                        new
                        {
                            ...
                            Grade = "12",
                            IsActive = true,
                            Password = "$2a$11$QRiswaMFDviQfSkyxWKblO0BoseOtfLwyARB.rA3I98uOWfZy7.sS",
            ...
            modelBuilder.Entity("webthitn_backend.Models.PracticeResult", b =>
                {
                    b.HasOne("webthitn_backend.Models.PracticeExam", "PracticeExam")
                        .WithMany()
                        .HasForeignKey("PracticeExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
