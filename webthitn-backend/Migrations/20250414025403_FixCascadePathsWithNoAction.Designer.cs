...
namespace webthitn_backend.Migrations
{
    ...
    [Migration("20250414025403_FixCascadePathsWithNoAction")]
    partial class FixCascadePathsWithNoAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("webthitn_backend.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Grade = "N/A",
                            IsActive = true,
                            Password = "$2a$11$e2n8wdOBFmjS69Ga5dQ56.iRoQABOSfbPQ5vynTw07fpM4r67gZpm",
                            PhoneNumber = "N/A",
                            Role = "Admin",
                            School = "N/A",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            Password = "$2a$11$R9C/paIj.BNtHE4.TV.y5eAaZ2qgVcWKRsMJk.8b.MG5zncmogEky",
                        ...
                        new
                        {
                            ...
                            Grade = "12",
                            IsActive = true,
                            Password = "$2a$11$vp1S1npVbO02ogA.t9Oq9e1yYQ0Hj3/N7dgUIvvt2.JMXPqmwcyRi",
            ...
            modelBuilder.Entity("webthitn_backend.Models.ExamQuestion", b =>
                {
                    ...
                    b.HasOne("webthitn_backend.Models.Question", null)
                        .WithMany("ExamQuestions")
            ...
            modelBuilder.Entity("webthitn_backend.Models.ExamResult", b =>
                {
                    ...
                    b.HasOne("webthitn_backend.Models.ExamSession", "ExamSession")
                        .WithOne()
                        .HasForeignKey("webthitn_backend.Models.ExamResult", "SessionId");
            ...
            modelBuilder.Entity("webthitn_backend.Models.ExamSession", b =>
                {
                    ...
                    b.HasOne("webthitn_backend.Models.ExamResult", "ExamResult")
                        .WithOne()
                        .HasForeignKey("webthitn_backend.Models.ExamSession", "ExamResultId")
                        .OnDelete(DeleteBehavior.NoAction);
